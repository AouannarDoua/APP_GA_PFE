...
public class Emploi_TempsBD  extends SQLiteOpenHelper {
    private static final String DATABASE_NAME = "amitEmploiS.db";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        insererEmploiTemps(db, 5, "S4", "droit C.S", "droit C.S", "Controle gestion", "activite org", "BD Oracle", "BD Oracle", "SQL*Plus", "SQL*Plus", "JAVA", "JAVA", "Controle gestion", "activite org", "BD Oracle", "BD Oracle","SQL*Plus", "SQL*Plus", "PFE", "PFE", "", "", "PFE", "PFE", "", "");
        insererEmploiTemps(db, 1, "S2", "RO", "LINUX", "MYSQL", "reseau", "securite", "JAVA", "matiere7", "matiere8", "matiere9", "matiere10", "matiere11", "matiere12", "matiere13", "matiere14", "matiere15", "matiere16", "matiere17", "matiere18", "matiere19", "matiere20", "matiere21", "matiere22", "matiere23", "matiere24");
        insererEmploiTemps(db, 3, "S3", "J2ee", "JAVA", "droit", "securite","matiere5", "matiere6", "matiere7", "matiere8", "matiere9", "matiere10", "matiere11", "matiere12", "matiere13", "matiere14", "matiere15", "matiere16", "matiere17", "matiere18", "matiere19", "matiere20", "matiere21", "matiere22", "matiere23", "matiere24");
        insererEmploiTemps(db, 1, "S4", "JA", "2ee", "sece", "s","matiere5", "matiere6", "matiere7", "matiere8", "matiere9", "matiere10", "matiere11", "matiere12", "matiere13", "matiere14", "matiere15", "matiere16", "matiere17", "matiere18", "matiere19", "matiere20", "matiere21", "matiere22", "matiere23", "matiere24");
        insererEmploiTemps(db, 2, "S1", "JAV", "Jee", "oit", "s","matiere5", "matiere6", "matiere7", "matiere8", "matiere9", "matiere10", "matiere11", "matiere12", "matiere13", "matiere14", "matiere15", "matiere16", "matiere17", "matiere18", "matiere19", "matiere20", "matiere21", "matiere22", "matiere23", "matiere24");
    }
